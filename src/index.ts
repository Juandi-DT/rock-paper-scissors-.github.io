...
const tittleResult:Element| null = document.querySelector(".mos-resultado-title");
const img1:Element| null = document.querySelector(".img1");
const img2:Element| null = document.querySelector(".img2");
const jugarDeNuevo:Element| null = document.querySelector(".Resultado-button");
...
let opcionContrincante:Piedra | Papel | Tijera = options[randomNumberForEnemy];
...
// Animacion
const opcionImagen:string[] = ['rockIMG',`paperIMG`,'scissorsIMG','rockIMG',`paperIMG`,'scissorsIMG'];
let time:number = 300;
